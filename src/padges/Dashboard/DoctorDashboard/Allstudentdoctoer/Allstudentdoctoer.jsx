...
const items = [
    { id: 1, name: "John Doe", studentId: "12345" },
    { id: 2, name: "Jane Smith", studentId: "12346" },
    { id: 3, name: "Michael Johnson", studentId: "12347" },
    { id: 4, name: "Emily Davis", studentId: "12348" },
    { id: 5, name: "David Wilson", studentId: "12349" },
    { id: 6, name: "Sophia Lee", studentId: "12350" },
    { id: 7, name: "James Brown", studentId: "12351" },
    { id: 8, name: "Olivia White", studentId: "12352" },
    { id: 9, name: "William Harris", studentId: "12353" },
    { id: 10, name: "Isabella Clark", studentId: "12354" },
    { id: 11, name: "John Doe", studentId: "12345" },
    { id: 12, name: "Jane Smith", studentId: "12346" },
    { id: 13, name: "Michael Johnson", studentId: "12347" },
    { id: 14, name: "Emily Davis", studentId: "12348" },
    { id: 15, name: "David Wilson", studentId: "12349" },
    { id: 16, name: "Sophia Lee", studentId: "12350" },
    { id: 17, name: "James Brown", studentId: "12351" },
    { id: 18, name: "Olivia White", studentId: "12352" },
    { id: 19, name: "William Harris", studentId: "12353" },
    { id: 20, name: "Isabella Clark", studentId: "12354" },
  ];
export default function Allstudentdoctoer() {
    ...
    const handleKeyDown = (e) => {
      if (e.key === "Enter") {
        ...
        handleSearch();
                            ...
                            const exportToExcel = () => {
                              const exportData = filteredItems.map(({ id, name, studentId   }) => ({
                                ID: id,
                                Name: name,
                                StudentID: studentId,
    ...
    <div>
       <div className='lg:flex items-center  lg:justify-between  '>
              <div className='flex  gap-2 m-3 lg:m-3 justify-self-center'>
                             <button onClick={() => navigate("/doctor-dashboard/coursessdoctoer")} className='flex gap-2 items-center  text-[#161B39]'>
                       ...
                       <div className='flex '>
                          ...
                          <button className='  flex items-center self-center bg-[#161B39] justify-center text-[white] m-2 w-48 max-md:text-[13px]  rounded-[8px] h-11'>
                         
                          <i className="fa-solid fa-plus" />
                          <p className='p-2'  onClick={() => navigate("/doctor-dashboard/coursessdoctoer/allstudentdoctoer/addstudentdoctoer")}>Add new student </p>
                          </button>
