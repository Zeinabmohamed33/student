...
export default function Allcourseshtml() {
                  ...
                  <div className='md:relative '>
                         <div className='md:w-[63%] max-md:w-[95%] md:left-[17%] md:absolute top-40'>
                            <ul className=''>
                                ...
                                <li>
                                  <Link to="/admin-dashboard/allcourdessadmin/htmlstudentadmin" className="flex items-center p-2 text-gray-900 rounded-lg cursor-pointer hover:bg-gray-100 ">
                               ...
                               <div className='h-[0.1px] bg-[#a1a1a1d6] w-[100%]   m-1'></div>
                                ...
                                <li>
                                  <Link to="/admin-dashboard/allcourdessadmin/absentstudentadmin" className="flex items-center p-2 text-gray-900 rounded-lg cursor-pointer hover:bg-gray-100 ">
                               <span className='ml-0' > <img src={denger} alt="" /> </span>
                                ...
                                <li>
                                             <Link to="/admin-dashboard/allcourdessadmin/fillteradmin" className="flex items-center p-2 text-gray-900 rounded-lg cursor-pointer hover:bg-gray-100 ">
                                ...
                                <li>
                                  <Link to="/admin-dashboard/allcourdessadmin/sectionreportadmin" className="flex items-center p-2 text-gray-900 rounded-lg cursor-pointer hover:bg-gray-100">
                               ...
                               <div className='h-[0.1px] bg-[#a1a1a1d6] w-[100%]   m-1'></div>
                                ...
                                <li>
                                  <Link to="/admin-dashboard/allcourdessadmin/leturereportadmin" className="flex items-center p-2 text-gray-900 rounded-lg cursor-pointer hover:bg-gray-100">
                               ...
                               <div className='h-[0.1px] bg-[#a1a1a1d6] w-[100%]   m-1'></div>
                                  ...
                                  <li>
                                  <Link to="/admin-dashboard/allcourdessadmin/editecoursesadmin" className="flex items-center p-2 text-gray-900 rounded-lg cursor-pointer hover:bg-gray-100 ">
                                 
                               <span className='ml-0' > <img src={editee} alt="" /> </span>
                                  <span className="flex-1 ms-3 text-[#161C39] whitespace-nowrap"> edit course information</span>
                                  <span className="inline-flex items-center justify-center px-2 text-sm font-medium ">
                                    <img src={vectorright} alt="" />
                                  </span>
