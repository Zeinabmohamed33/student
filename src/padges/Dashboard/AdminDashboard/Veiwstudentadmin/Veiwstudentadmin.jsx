...
export default function Veiwstudentadmin() {
  ...
  return (
   ...
   <div className='flex  gap-2 m-3 lg:m-3 justify-self-center'>
            ...
            <i className="fa-solid fa-chevron-right mt-1" style={{ color: "#71717a" }} />
            <h1 className='text-[#71717A] '> student information </h1>

           
 
            </div>
            <div className='flex '>
               <button   className='bg-[#EF1A1D] text-[white] m-2 w-32 max-md:text-[13px]  rounded-[8px] h-11'>delete student </button>
               <button onClick={() => {
if (isEditing) {
 // Save mode
 const localData = JSON.parse(localStorage.getItem("students")) || [];
...
<button onClick={() => navigate("/admin-dashboard/newdocteradmin/changpassworeddocteradmin")}
