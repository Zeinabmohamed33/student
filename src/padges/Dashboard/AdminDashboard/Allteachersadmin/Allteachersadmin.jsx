...
export default function Allteachersadmin() {
  ...
  return (
        ...
        <div className='flex  gap-2 m-3 lg:m-3 justify-self-center'>
                 ...
                 <div className='flex '>
                    ...
                    <i className="fa-solid fa-plus" />
                       <p className='p-2'  onClick={() => navigate("/admin-dashboard/newstudentadmin")}>Add new teacher  </p>
                    </button>
    ...
    <div className="relative ">
      ...
      <div className="flex gap-2">
        <button 
       onClick={() => navigate(`/admin-dashboard/Veiwteacheradmin/${item.id}`)}
